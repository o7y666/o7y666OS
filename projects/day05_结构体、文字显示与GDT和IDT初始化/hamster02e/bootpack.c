...
{	
	...
	putfont8(binfo->vram, binfo->scrnx, 10, 10, 0, hankaku+'A'*16);
	putfont8(binfo->vram, binfo->scrnx, 18, 10, 0, hankaku+'b'*16);
	putfont8(binfo->vram, binfo->scrnx, 28, 10, 0, hankaku+'c'*16);
	putfont8(binfo->vram, binfo->scrnx, 38, 10, 0, hankaku+'d'*16);
	putfont8(binfo->vram, binfo->scrnx, 48, 10, 0, hankaku+'e'*16);
	putfont8(binfo->vram, binfo->scrnx, 58, 10, 0, hankaku+'f'*16);
